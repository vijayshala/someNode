...
const initSpacesSalesModels = async (options) => {
  ...
  const ucSolutionUserTypes = (salesModelIdentifier) => {
    return [
      // {
      // isPrimary: true,
      // identifier: 'spaces-essential-user',
      // title: {
      //   text: 'Essential User',
      // },
      // descriptions: [{
      ...
      {
        isPrimary: true,
        identifier: 'spaces-business-user',
        title: {
          text: 'Business User',
        },
        descriptions: [{
  ...
  docs = [{
    ...
    items: [
      ...ucSolutionUserTypes('spaces-solution-monthly-us'),
    ...
    currency: 'USD',
    allowed_regions: ['US'],
    identifier: 'spaces-solution-yearly-us',
    title: {
    ...
    rules: [...collaborationsStandardRules],
    items: [
      ...ucSolutionUserTypes('spaces-solution-yearly-us'),
      // ...ucSolutionSystemAddons,      
    ],
    tags: ['collaborations', 'spaces-solution'],
    legalDocuments: [generalLegalDocument],
