...
const initSpacesOffers = async (options) => {
  ...
  docs = [{
    identifier: 'avaya-spaces-us',
    active: true,
    slug: 'avaya-spaces-us',
    title: {
      text: 'Avaya Spaces (US)',
    ...
    salesModels: [{
      salesModel: {
        identifier: 'spaces-solution-monthly-us',
        _id: salesModelsMap['spaces-solution-monthly-us'] && salesModelsMap['spaces-solution-monthly-us']._id,
      }
    }, {
      salesModel: {
        identifier: 'spaces-solution-yearly',
        _id: salesModelsMap['spaces-solution-yearly-us'] && salesModelsMap['spaces-solution-yearly-us']._id,
      }
    }
    ],
    displaySequence: 0,
