const ns = '[QuoteContentContainer]';
...
//containers
import OfferStepperContainer from '../OfferShoppingWizardContainer/OfferStepperContainer';
import StepPrimarySalesItemContainer from '../OfferShoppingWizardContainer/StepPrimarySalesItemContainer';
import StepSelectAddonsContainer from '../OfferShoppingWizardContainer/StepSelectAddonsContainer';
import OfferPrimaryItemFeaturesContainer from '../OfferShoppingWizardContainer/OfferPrimaryItemFeaturesContainer'
import OfferContentTotalContainer from '../OfferShoppingWizardContainer/OfferContentTotalContainer'
import StepSelectDIDContainer from '../OfferShoppingWizardContainer/StepSelectDIDContainer'
import StepDevicesContainer from '../OfferShoppingWizardContainer/StepDevicesContainer'
import StepUsersDeviceSelectionContainer from '../OfferShoppingWizardContainer/StepUsersDeviceSelectionContainer'
import StepCustomerInfoContainer from './StepCustomerInfoContainer'
...
class QuoteContentContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getComponentByName(componentName, options = {}) {
    switch (componentName) {
      ...
      case 'StepCustomerInfoContainer':
        logger.info(ns, 'customer StepCustomerInfoContainer found');
        return <StepCustomerInfoContainer key={componentName} {...options} />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(QuoteContentContainer));
